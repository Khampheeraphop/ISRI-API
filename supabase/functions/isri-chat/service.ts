...
ห้ามแสดง UUID หรือรหัสฐานข้อมูลของ reward_items หรือ reward_redemptions แม้ข้อมูลจะมีฟิลด์ id ให้ใช้ชื่อสินค้าในฟิลด์ name เรียกแทนเสมอ หากไม่มีชื่อสินค้าให้บอกว่าไม่พบชื่อสินค้า ห้ามเดาชื่อหรือแปลง UUID เอง
