...
-- ---------------------------------------------------------------------------
insert into public.pm_schedules (id, location_id, location_label, asset_name, plan_details, interval_months, last_done_at, next_due_at, assigned_technician_id)
values
  ('80000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000007','อาคารผู้ป่วยนอก · ทุกชั้น · โถงลิฟต์ A','ลิฟต์โดยสาร A','ตรวจสอบระบบประตู เบรกฉุกเฉิน สัญญาณเตือน และทดสอบการทำงานทุกชั้น',1,now()-interval '35 days',now()-interval '5 days','10000000-0000-0000-0000-000000000003'),
  ('80000000-0000-0000-0000-000000000002','20000000-0000-0000-0000-000000000005','อาคารเภสัชกรรม · ชั้น 1 · ห้องเก็บเวชภัณฑ์','เครื่องปรับอากาศควบคุมอุณหภูมิ','ล้างแผงกรอง ตรวจแรงดันน้ำยา และทดสอบการควบคุมอุณหภูมิห้องเก็บเวชภัณฑ์',3,now()-interval '89 days',now()+interval '1 day','10000000-0000-0000-0000-000000000004'),
  ('80000000-0000-0000-0000-000000000003','20000000-0000-0000-0000-000000000004','อาคารอุบัติเหตุและฉุกเฉิน · ชั้น 1 · หน้าห้องกู้ชีพ','ตู้จ่ายไฟฟ้าฉุกเฉิน','ตรวจความแน่นของจุดต่อสาย วัดความร้อนสะสม และทดสอบไฟฟ้าสำรอง',1,now()-interval '25 days',now()+interval '5 days','10000000-0000-0000-0000-000000000003'),
  ('80000000-0000-0000-0000-000000000004','20000000-0000-0000-0000-000000000010','อาคารอำนวยการ · ชั้น 2 · ห้องประชุมใหญ่','ระบบปรับอากาศส่วนกลาง','ตรวจชุดควบคุม ทำความสะอาดชุดกรอง และทดสอบการกระจายลมของระบบส่วนกลาง',6,now()-interval '4 months',now()+interval '2 months','10000000-0000-0000-0000-000000000004'),
  ('80000000-0000-0000-0000-000000000005','20000000-0000-0000-0000-000000000003','อาคารผู้ป่วยใน · ชั้น 3 · หอผู้ป่วยอายุรกรรม','ระบบน้ำประปาหอผู้ป่วย','ตรวจแรงดันน้ำ วาล์ว ระบบระบายน้ำ และจุดเสี่ยงการรั่วซึมในหอผู้ป่วย',3,now()-interval '2 months',now()+interval '1 month','10000000-0000-0000-0000-000000000003');
